...
const CreateBrand = React.lazy(() => import('./views/brand/CreateBrand'))
...
const routes = [
  ...
  { path: '/contacts/index', name: 'Contacts', element: Contact },
  { path: '/users/index', name: 'Users', element: User },
  { path: '/users/create', name: 'CreateUser', element: CreateUser },
  { path: '/product/index', name: 'Product', element: Product },
  { path: '/product/create', name: 'CreateProduct', element: CreateProduct },
  { path: '/category/index', name: 'Category', element: Category },
