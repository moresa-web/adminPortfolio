...
const CreateBrand = () => {
    ...
    function PostData(e) {
        ...
        fetch("https://localhost:7239/api/v1/Product/Brand", {
            method: "POST",
            body: JSON.stringify(document.getElementById("brand").value),
        ...
        <>
            {isLoading ? (
                ...
                <CForm className="row g-3" onSubmit={PostData}>
                    <CCol md={6}>
                        <CFormInput type="text" name="brand" id="brand" label="Brand" />
                    </CCol>
                    <CCol xs={12}>
